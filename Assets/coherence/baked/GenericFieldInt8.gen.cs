...
namespace Coherence.Generated
{
	...
	public struct GenericFieldInt8 : ICoherenceComponentData
	{
		...
		{
			uint mask = 0;
			var newData = (GenericFieldInt8)data;
		...
		public static void Serialize(GenericFieldInt8 data, uint mask, IOutProtocolBitStream bitStream)
		{
		...
		public static (GenericFieldInt8, uint, uint) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
