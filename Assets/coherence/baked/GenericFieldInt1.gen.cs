...
namespace Coherence.Generated
{
	...
	public struct GenericFieldInt1 : ICoherenceComponentData
	{
		...
		{
			return $"GenericFieldInt1(number: {number})";
		}
		...
		public static void Serialize(GenericFieldInt1 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			{
				Coherence.Utils.Bounds.Check(data.number, _number_Min, _number_Max, "GenericFieldInt1.number");
		...
		{
			var last = lastSent as GenericFieldInt1?;
		}
	}
}