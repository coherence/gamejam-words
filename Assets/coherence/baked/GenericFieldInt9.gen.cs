...
namespace Coherence.Generated
{
	...
	public struct GenericFieldInt9 : ICoherenceComponentData
	{
		...
		{
			return $"GenericFieldInt9(number: {number})";
		}
		...
		public static void Serialize(GenericFieldInt9 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			{
				Coherence.Utils.Bounds.Check(data.number, _number_Min, _number_Max, "GenericFieldInt9.number");
		...
		{
			var last = lastSent as GenericFieldInt9?;
		}
	}
}