...
namespace Coherence.Generated
{
	...
	public struct GenericFieldUInt4 : ICoherenceComponentData
	{
		...
		{
			return $"GenericFieldUInt4(number: {number})";
		}

		public uint GetComponentType() => Definition.InternalGenericFieldUInt4;
		...
		{
			uint mask = 0;
			var newData = (GenericFieldUInt4)data;
		...
		public static void Serialize(GenericFieldUInt4 data, uint mask, IOutProtocolBitStream bitStream)
		{
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.number, _number_Min, _number_Max, "GenericFieldUInt4.number");
		...
		public static (GenericFieldUInt4, uint, uint?) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
