...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncPlayerCursor : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			if (coherenceSync.TryGetBindingByGuid("", "position", out InternalWorldPosition_Translation_value_Binding))
			{
			...
			if (coherenceSync.TryGetBindingByGuid("", "rotation", out InternalWorldOrientation_Rotation_value_Binding))
			{
			...
			if (coherenceSync.TryGetBindingByGuid("", "playerName", out InternalPlayerCursor_Player_694873017490517114_PlayerCursor_Player_694873017490517114_playerName_Binding))
			{
			...
			if (coherenceSync.TryGetBindingByGuid("", "startOnFrame", out InternalPlayerCursor_Player_694873017490517114_PlayerCursor_Player_694873017490517114_startOnFrame_Binding))
			{
		...
		public override void PerformInterpolation()
		{
			...
			{
				_transformViaCoherenceSync_5087559671055490318.coherencePosition = InternalWorldPosition_Translation_value_Binding.InterpolationSettings.PerformInterpolationVector3((Vector3)_transformViaCoherenceSync_5087559671055490318.coherencePosition, monoBridge.NetworkTime.TimeAsDouble) ;
			}
			if (InternalWorldOrientation_Rotation_value_Binding.ShouldApplyNetworkData())
			{
				_transformViaCoherenceSync_5087559671055490318.coherenceRotation = InternalWorldOrientation_Rotation_value_Binding.InterpolationSettings.PerformInterpolationQuaternion((Quaternion)_transformViaCoherenceSync_5087559671055490318.coherenceRotation, monoBridge.NetworkTime.TimeAsDouble) ;
			}
		...
		public override void ResetInterpolation(bool setToLastSamples)
		{
			if (setToLastSamples && InternalWorldPosition_Translation_value_Binding.InterpolationSettings.GetSampleType() != null)
			{
				...
				if (sample != null) 
				{
					...
					_transformViaCoherenceSync_5087559671055490318.coherencePosition = lastSample;
				}
			}
			...
			if (setToLastSamples && InternalWorldOrientation_Rotation_value_Binding.InterpolationSettings.GetSampleType() != null)
			{
				...
				if (sample != null) 
				{
					...
					_transformViaCoherenceSync_5087559671055490318.coherenceRotation = lastSample;
				}
			}
