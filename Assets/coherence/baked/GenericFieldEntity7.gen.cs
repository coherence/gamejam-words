...
namespace Coherence.Generated
{
	...
	public struct GenericFieldEntity7 : ICoherenceComponentData
	{
		...
		{
			uint mask = 0;
			var newData = (GenericFieldEntity7)data;
		...
		public static void Serialize(GenericFieldEntity7 data, uint mask, IOutProtocolBitStream bitStream)
		{
		...
		public static (GenericFieldEntity7, uint, uint) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
