...
namespace Coherence.Generated
{
	...
	public struct GenericFieldVector3 : ICoherenceComponentData
	{
		...
		public static void Serialize(GenericFieldVector3 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			{
				Coherence.Utils.Bounds.Check(data.Value.x, _Value_Min, _Value_Max, "GenericFieldVector3.Value.x");

				Coherence.Utils.Bounds.Check(data.Value.y, _Value_Min, _Value_Max, "GenericFieldVector3.Value.y");

				Coherence.Utils.Bounds.Check(data.Value.z, _Value_Min, _Value_Max, "GenericFieldVector3.Value.z");
