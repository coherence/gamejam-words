...
namespace Coherence.Generated
{
	...
	public struct GenericField2dVector0 : ICoherenceComponentData
	{
		...
		public static void Serialize(GenericField2dVector0 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			{
				Coherence.Utils.Bounds.Check(data.Value.x, _Value_Min, _Value_Max, "GenericField2dVector0.Value.x");

				Coherence.Utils.Bounds.Check(data.Value.y, _Value_Min, _Value_Max, "GenericField2dVector0.Value.y");
